...
val md_theme_light_primaryContainer = Color(0xFFE9E86E)
...
val md_theme_dark_surfaceTint = Color(0xFFCCCC56)
val md_theme_dark_outlineVariant = Color(0xFF48473A)
val md_theme_dark_scrim = Color(0xFF000000)


val seed = Color(0xFF7B7B00)

val backgroundGradient = Brush.verticalGradient(
    colors = listOf(
        md_theme_dark_primary.copy(0.5f),
